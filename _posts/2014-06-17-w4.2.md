...
* Kathryn Day: "1:1 will enable the realisation of truly personalised learning."
* William Whiting: "The strongest argument I think of for having one on one devices is that students will have easy access to their work and the ability to retrieve their work without the hassle of logging on to a school computer and looking for their work in the clouds.  It makes the iPad more like a traditional note book."
* autonomous learning, encourage independence, students work on their own pace
* Marcelo Jose da Silva: "Having their own device students have more opportunities to practice. They can use it inside or outside the school environment."
...
* James Callus: enagement on collaborative tasks, equal access to information to all learners, the opportunity to create and publish digital artefacts, self paced learning, research skills
